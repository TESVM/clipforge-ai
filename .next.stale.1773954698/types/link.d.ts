...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    ...
    | `/api/clips/${SafeSlug<T>}`
    | `/api/clips/${SafeSlug<T>}/export`
    | `/api/export-jobs/${SafeSlug<T>}`
    | `/api/projects/${SafeSlug<T>}`
    | `/api/projects/${SafeSlug<T>}/process`
    | `/dashboard/clips/${SafeSlug<T>}`
    | `/dashboard/projects/${SafeSlug<T>}`
